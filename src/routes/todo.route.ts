...
router.get("/:id", TodoMiddleware.isValidUserId, async (req, res) => {
	try {
...
router.put("/:id", TodoMiddleware.isValidUserId, async (req, res) => {
	try {
...
router.delete("/:id", TodoMiddleware.isValidUserId, async (req, res) => {
	try {
